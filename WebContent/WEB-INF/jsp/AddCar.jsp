...
<body>	
	<div class="container">
		...
		<form id="form1" class="form-horizontal" method="get" action="addcar1.action">
			<div class="form-group">
				<label for="" class="col-sm-2">车牌号</label>
				<div class="col-sm-10">
					<input type="text" id="deptName" name="cno" placeholder="请输入车牌号" class="form-control"/>
				</div>					
			</div>	
			<div class="form-group">
				<label for="" class="col-sm-2">品牌</label>
				<div class="col-sm-10">
					<input type="text" id="" name="cname" placeholder="请输入品牌" class="form-control"/>
				</div>					
			</div>
			<div class="form-group">
				<label for="" class="col-sm-2">驾驶证</label>
				<div class="col-sm-10">
					<select name="dno" id="deptId" class="form-control">
						<option value="0">请选择驾驶证</option>	
						<c:forEach items="${list }" var="c">
								<option value="${c.dno }">${c.dno }</option>
						</c:forEach>				
					</select>
				</div>					
			</div>
